<?php
  ...
  $ssqlGetRefNums = "SELECT uniquekey, ".$sstrTableName.".RefNum FROM ".$sstrTableName." INNER JOIN CIRB_".$gCDstrOrgAbbr."Protocol ON ".$sstrTableName.".RefNum = CIRB_".$gCDstrOrgAbbr."Protocol.RefNum";//join is to make sure we only fix ones that are actually in the protocol table
