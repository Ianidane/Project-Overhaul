...
//        echo "<textarea rows=10 cols=75 id='valuememInclExcl'>".$text."</textarea><br>";
      ...
      if(substr($tag[$i]['Name'],0,3) == 'mem'){
        ...
        echo $tag[$i]['Name']." ";
        echo "<input type=button value='Investigate' onclick=Investigate('".$tag[$i]['Name']."')> ";
        echo "<input type=button value='Investigate no RTF' onclick=InvestigateNoRTF('".$tag[$i]['Name']."')> ";
